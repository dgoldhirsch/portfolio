package com.cornmuffin.products.data.room

import androidx.room.Database
import androidx.room.RoomDatabase
import com.cornmuffin.products.data.products.Product
import com.cornmuffin.products.data.room.products.ProductDao
import com.cornmuffin.products.data.room.products.ProductEntity
import com.cornmuffin.products.data.room.products.ProductsUpdatedAtDao
import com.cornmuffin.products.data.room.products.ProductsUpdatedAtEntity
import com.cornmuffin.products.data.room.settings.SettingsDao
import com.cornmuffin.products.data.room.settings.SettingsEntity
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        const val DATABASE_NAME = "com.cornmuffin.products"
    }
}
